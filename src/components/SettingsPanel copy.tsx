...
export function SettingsPanel({ open, onClose }: Props) {
  ...
  const gradients = [
     'linear-gradient(135deg, #1e1b4b 0%, #311042 100%)', // Deep Dark Purple
     'linear-gradient(135deg, #0f172a 0%, #1e293b 100%)', // Slate Gray
     'linear-gradient(135deg, #111827 0%, #312e81 100%)', // Midnight Blue
     'linear-gradient(135deg, #1a1a2e 0%, #16213e 100%)', // Tech Navy
     'linear-gradient(135deg, #2d124d 0%, #1a0b2e 100%)', // Dark Violet
     'linear-gradient(135deg, #022c22 0%, #064e3b 100%)', // Emerald Night
     'linear-gradient(135deg, #1c1917 0%, #44403c 100%)', // Dark Stone
     'linear-gradient(135deg, #3b0764 0%, #1d4ed8 100%)'  // Purple to Royal Blue
